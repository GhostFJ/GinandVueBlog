...
-- ----------------------------
BEGIN;
INSERT INTO `blog_article` VALUES ('1', '1', '测试', '程序测试', '个人博客项目开发使用，API测试分析', '1575945565', 'test-created', '1575945829', 'test-created-edit', '0', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `blog_comments` VALUES ('1', '1', '1', 'test', '0', '', '0', '', '0');
COMMIT;
